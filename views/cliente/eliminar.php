...
<body class="bg-dark text-white">
	...
	<div class="container my-5">
		<h1 class="text-center mb-4 py-3" style="background-color: #fc00ff;">Eliminar Cliente</h1>
		...
		<form method="post" class="bg-black p-4 rounded shadow-sm border border-3" style="border-color: #00fffc;">
			...
			<div class="d-flex justify-content-between">
				...
				<input type="submit" class="btn fw-bold text-white" style="background-color: #fc00ff;" value="Eliminar">
			</div>
		</form>
