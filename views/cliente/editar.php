...
<body class="bg-dark text-white">
	...
	<div class="container my-5">
		<h1 class="text-center mb-4 py-3" style="background-color: #00fffc; color: #000000;">Editar Cliente</h1>

		<form method="post" class="bg-black p-4 rounded shadow-sm border border-3" style="border-color: #fc00ff;">
			<div class="mb-3">
			...
			<div class="d-flex justify-content-between">
				...
				<input type="submit" class="btn text-white fw-bold" style="background-color: #00fffc; color: #000000;" value="Guardar">
			</div>
		</form>
