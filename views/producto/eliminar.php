...
<body class="bg-light text-dark">
	...
	<div class="container my-5">
		<h1 class="text-center mb-4 text-white py-3" style="background-color: #ef476f;">Eliminar Producto</h1>
		...
		<form method="post" class="bg-white p-4 rounded shadow-sm border">
			...
			<div class="d-flex justify-content-between">
				...
				<input type="submit" class="btn text-white" style="background-color: #ef476f;" value="Eliminar">
			</div>
		</form>
